package redehyzen.escolhendo.utils.upgrade;

import escolhendo.apexstore.services.cash.CashException;
import escolhendo.apexstore.services.cash.CashManager;
...
public class Upgrade {
  ...
  public static Map<String, Upgrade> QUEUE_VIPS;
  ...
  public ItemStack getIcon(Profile profile) {
    long cash = profile.getStats("ApexServicesProfile", "cash");
  ...
  public void dispatchPack(Player player) {
    ...
    urlDiscord.setClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, "https://redehyzen.com.br/discord"));
