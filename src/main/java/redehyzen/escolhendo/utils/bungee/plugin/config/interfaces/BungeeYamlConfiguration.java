...
public class BungeeYamlConfiguration extends YamlConfiguration {
  ...
  public boolean reload() {
    try {
      ...
      Bungee.getInstance().getLogger().log(Level.SEVERE, "Unexpected error ocurred reloading file " + file.getName() + ": ", ex);
      return false;
    }
  }
  ...
  public boolean save() {
    try {
      ...
      Bungee.getInstance().getLogger().log(Level.SEVERE, "Unexpected error ocurred saving file " + file.getName() + ": ", ex);
      return false;
    }
  }
