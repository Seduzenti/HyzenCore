package redehyzen.escolhendo.utils.menus;
...
import escolhendo.apexstore.services.libraries.menu.PlayerMenu;
      ...
      if (evt.getWhoClicked().equals(this.player)) {
        ...
        if (evt.getClickedInventory() != null && evt.getClickedInventory().equals(this.getInventory())) {
          ...
          if (item != null && item.getType() != Material.AIR) {
            if (evt.getSlot() == 12) {
              if (profile.getStats("ApexServicesProfile", "cash") < this.upgrade.getCash()) {
